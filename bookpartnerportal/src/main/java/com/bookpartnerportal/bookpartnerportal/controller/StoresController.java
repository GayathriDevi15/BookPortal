...
public class StoresController {
	...
	public StoresController(StoresServiceImplementation storesserviceimplementation) {

		this.storesserviceimplementation = storesserviceimplementation;
	}
	...
	public ResponseEntity<SuccessResponse> updateStore(@PathVariable("storId") String storId,
	...
	public ResponseEntity<SuccessResponse> createStore(@RequestBody Stores stores) {
		...
		// if(createdStore.getStorId().isEmpty() || createdStore.getZip().isEmpty() ||
		// createdStore.getCity().isEmpty() || createdStore.getState().isEmpty() ||
		// createdStore.getStorAddress().isEmpty() ) {
